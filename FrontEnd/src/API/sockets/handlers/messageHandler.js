...
export default function registerMessageHandler(socket, dispatch) {
  ...
  const handleMessageEdited = (payload) => {
    ...
    dispatch({ type: "channelMessages/updateMessageContent", payload: updatePayload });
    dispatch({ type: "conversMessages/updateMessageContent", payload: updatePayload });
    dispatch({ type: "threads/updateThreadMessageContent", payload: updatePayload });
    dispatch({ type: "chatPanel/updateThreadParentContent", payload: updatePayload });
  };
