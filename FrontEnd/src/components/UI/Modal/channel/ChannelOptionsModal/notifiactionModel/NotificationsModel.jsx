...
import styles from "./NotificationsModel.module.css";
import { closeNotificationsModel } from "../../../../../../API/redux/chat/channel/notificationsModelSlice";
...
const NotificationsModal = ({ onClose }) => {
    ...
    function closeModel(e) {
        if (e.target === e.currentTarget)
            dispatch(closeNotificationsModel())
    }
        ...
        <div className="overlay" onClick={closeModel}>
            <div className={styles.modalContainer}>
                ...
                <div className={styles.radioGroup}>
                    <label><input type="radio" name="notifications" defaultChecked /> All new messages</label>
                    <label><input type="radio" name="notifications" /> Mentions</label>
                    <label><input type="radio" name="notifications" /> Nothing</label>
                </div>
                ...
                <div className={styles.note}>
                    <span>Note: You can set notification keywords and change your workspace-wide settings in your </span>
                    <a href="#">Preferences</a>.
                </div>
                <hr className="divider" />

                <div className={styles.modalFooter}>
                    <div className={styles.cancelBtn} onClick={onClose}>Cancel</div>
