...
import { BsArrowDown, BsArrowUp, BsBell} from "react-icons/bs";
                  ...
                  <div className={styles.infoTopic}>
                    ...
                    <div className={styles.bottom}>
                      <div className={styles.selectElement}>
                        <span className="align-items-center f-16">
                          Everyone
                        </span>
                  ...
                  <div className={styles.infoTopic}>
                    <div>
                      ...
                      <p className="f-15 mw-80">
                        Reorder, add, remove and hide the tabs that everyone
                        sees in this channel.
                      </p>
                    </div>
                    <div className={styles.tabsItems}>
                      ...
                      <div className={styles.newTab}>
                        ...
                        <span className="align-items-center f-bold">
                          New Tab
                        </span>
                      </div>
                    </div>
                ...
                <div className={styles.infoRow}>
                  <div className={styles.infoTopic}>
                    <div className={styles.actionItem}>
                      ...
                      <div>
                        Change to a{" "}
                        {channelData.isPrivate ? "pubic" : "private"} channel
                      </div>
                    </div>
                  </div>
                  <div className={styles.infoTopic}>
                    <div
                      className={`${styles.actionItem} ${styles.archiveItem}`}
                    >
                      <span className="align-items-center">
                        <FaArchive />
                      </span>
